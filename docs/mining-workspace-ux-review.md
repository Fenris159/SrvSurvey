...
- Wide, equal-width columns and nested vertical scrolling made location and purpose hard to follow. Search results now use wrapping location/detail cards, one bounded result viewport, and fixed actions. Advanced filters have a separate bounded area. Other page-oriented mining lists let their page own vertical scrolling.
