...
| `FormPlayComms` / `FormPlayComms2` | Quest communications | Lossless legacy local loading/saves, Raven service contracts, and the cancellable Lua chapter runtime with journal/emote/message dispatch and original scripting helpers are implemented; live composition, player workspace, and compact quest indicator remain |
