...
| `FormPlayJournal` | Diagnostics / Journal inspector | Partially implemented with the newest 120 live/raw events, bounded structured property browsing, live Status.json details, coordinate copying, runtime-compatible nested Lua handler generation, and clipboard copy; guarded quest replay remains |
