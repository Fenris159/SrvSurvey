...
| `FormStartNewCmdr` | Multiple commanders/windows | Partial: legacy `-fid` and new `--frontier-id` startup selection isolate each process to the newest matching commander journal; commander picker and process launch remain |
