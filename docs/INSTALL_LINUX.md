...
mv "$HOME/Downloads/SrvSurvey-XP-2.1.3.0-rc.51-x86_64.AppImage" \
...
Replace `2.1.3.0-rc.51` with the downloaded version. Keeping the installed name
...
tar -xzf "$HOME/Downloads/SrvSurvey-XP-2.1.3.0-rc.51-linux-x64.tar.gz" \
