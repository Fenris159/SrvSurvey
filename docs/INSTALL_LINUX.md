...
Current release candidate version: **SrvSurvey-XP 2.1.3.0-rc.58**.
...
mv "$HOME/Downloads/SrvSurvey-XP-2.1.3.0-rc.58-x86_64.AppImage" \
...
Replace `2.1.3.0-rc.58` with the downloaded version. Keeping the installed name
...
tar -xzf "$HOME/Downloads/SrvSurvey-XP-2.1.3.0-rc.58-linux-x64.tar.gz" \
