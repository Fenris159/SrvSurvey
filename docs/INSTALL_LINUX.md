...
Current release candidate version: **SrvSurvey-XP 2.1.3.0-rc.28**.
...
mv "$HOME/Downloads/SrvSurvey-XP-2.1.3.0-rc.28-x86_64.AppImage" \
    "$HOME/Applications/SrvSurvey/"
cd "$HOME/Applications/SrvSurvey"
chmod +x SrvSurvey-XP-2.1.3.0-rc.28-x86_64.AppImage
./SrvSurvey-XP-2.1.3.0-rc.28-x86_64.AppImage
```

Replace `2.1.3.0-rc.28` with the downloaded version. Keep the AppImage in this folder;
...
```bash
cd "$HOME/Applications/SrvSurvey"
./SrvSurvey-XP-2.1.3.0-rc.28-x86_64.AppImage --appimage-extract-and-run
```
...
```bash
mkdir -p "$HOME/Applications/SrvSurvey/2.1.3.0-rc.28"
tar -xzf "$HOME/Downloads/SrvSurvey-XP-2.1.3.0-rc.28-linux-x64.tar.gz" \
    -C "$HOME/Applications/SrvSurvey/2.1.3.0-rc.28"
cd "$HOME/Applications/SrvSurvey/2.1.3.0-rc.28"
