...
Current release candidate version: **SrvSurvey-XP 2.1.3.0-rc.54**.
...
mv "$HOME/Downloads/SrvSurvey-XP-2.1.3.0-rc.54-x86_64.AppImage" \
...
Replace `2.1.3.0-rc.54` with the downloaded version. Keeping the installed name
...
tar -xzf "$HOME/Downloads/SrvSurvey-XP-2.1.3.0-rc.54-linux-x64.tar.gz" \
