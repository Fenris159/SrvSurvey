...
public sealed class GuideIconPreviewControlTests
{
        ...
        string symbol)
    {
        return new GuideIconPreviewControl
        {
            ...
            PipConfirmedSegmentEdgeBrush = Brushes.DarkOrange,
            PipConfirmedPotentialSegmentEdgeBrush = Brushes.OrangeRed,
            PipConfirmedDimSegmentEdgeBrush = Brushes.SaddleBrown,
            PipConfirmedDimPotentialSegmentEdgeBrush = Brushes.Brown,
            PipPredictionSegmentEdgeBrush = Brushes.DarkCyan,
            PipPredictionPotentialSegmentEdgeBrush = Brushes.Cyan,
            PipHighlightSegmentEdgeBrush = Brushes.Gold,
            PipHighlightPotentialSegmentEdgeBrush = Brushes.Goldenrod,
            PipGlobalRegionalSegmentEdgeBrush = Brushes.Gray,
            PipGlobalRegionalPotentialSegmentEdgeBrush = Brushes.White,
        };
    }
