...
public sealed class LegacyOverlayLayoutImportMigratorTests : IDisposable
{
    ...
    public void ImportedAbsoluteDesktopAnchorsAreConvertedToRelativeDefaults()
    {
        ...
        LegacyOverlayLayoutImportMigrationResult result = LegacyOverlayLayoutImportMigrator.MigrateIfNeeded(paths);
        ...
        string saved = File.ReadAllText(Path.Combine(paths.DataDirectory, "plotters.json"));
        ...
        LegacyOverlayLayoutImportMigrationResult repeated = LegacyOverlayLayoutImportMigrator.MigrateIfNeeded(paths);
