...
public sealed class DockToDockLogServiceTests : IDisposable
{
    ...
    private static DockToDockLogEntry CreateEntry()
    {
        ...
        return new DockToDockLogEntry
        {
            ...
            EgressDuration = TimeSpan.Zero,
            IngressDuration = TimeSpan.Zero,
            Jumps = 0,
            Distance = 0,
            StartSystem = "Alpha",
            StartAddress = 1,
            StartBodyId = 2,
            StartBodyName = "Alpha 2",
            StartDistanceFromStarLs = 3,
            StartMarketId = 4,
            StartStationName = "Start",
            StartStationType = "Orbis",
            WasInterdicted = false,
            EndSystem = "Alpha",
            EndAddress = 1,
            EndBodyId = 2,
            EndBodyName = "Alpha 2",
            EndMarketId = 5,
            EndStationName = "End",
            EndStationType = "Outpost",
            EndDistanceFromStarLs = 3,
            ShipType = "python",
            ShipName = "Raven",
            ShipMaximumJump = 30,
