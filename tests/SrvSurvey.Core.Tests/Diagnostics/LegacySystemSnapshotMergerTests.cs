...
public sealed class LegacySystemSnapshotMergerTests
{
    ...
    public void MergePreservesUnknownDataAndAddsReconstructedExplorationState()
    {
        ...
        state.Apply(Parse("""{"event":"Location","StarSystem":"Test","SystemAddress":42,"StarPos":[1,2,3]}"""));
        ...
        Assert.Equal("2026-07-19T00:00:00.0000000+00:00", merged["firstVisited"]!.GetValue<string>());
    ...
    public void MergeKeepsMultipleSpeciesFromTheSameGenus()
    {
        ...
        Assert.Equal(
            ...
            organisms.Select(organism => organism!["variant"]!.GetValue<string>())
        );
    }
