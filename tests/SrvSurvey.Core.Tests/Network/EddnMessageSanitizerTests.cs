...
public sealed class EddnMessageBuilderTests
{
    ...
    public static TheoryData<string, string, string> DedicatedJournalEvents =>
        new()
        {
            {
                "FSSDiscoveryScan",
            ...
            { "NavBeaconScan", "navbeaconscan/1", "{\"SystemAddress\":123,\"NumBodies\":4}" },
            { "ScanBaryCentre", "scanbarycentre/1", "{\"StarSystem\":\"Test A\",\"SystemAddress\":123,\"BodyID\":4}" },
            {
                "FSSAllBodiesFound",
                "fssallbodiesfound/1",
    ...
    public void DedicatedJournalEventsUseTheirCurrentSchemas(string eventName, string schema, string fields)
    {
        ...
        {
            Assert.Null(prepared.message["Progress"]);
        }
    }
