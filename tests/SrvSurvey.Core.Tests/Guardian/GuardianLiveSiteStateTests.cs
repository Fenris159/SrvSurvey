...
public sealed class GuardianLiveSiteStateTests
{
    ...
    public void SurveyUpdatePreservesCollectedDataAndCorrectedSurfaceOrigin()
    {
        ...
        var existing = new GuardianCommanderSiteSurvey(
            ...
            string.Empty,
            "Old name",
            DateTimeOffset.Parse("2026-07-01T08:00:00Z", global::System.Globalization.CultureInfo.InvariantCulture),
            DateTimeOffset.Parse("2026-07-01T09:00:00Z", global::System.Globalization.CultureInfo.InvariantCulture),
            "Beta",
            12,
            42,
            "Test",
