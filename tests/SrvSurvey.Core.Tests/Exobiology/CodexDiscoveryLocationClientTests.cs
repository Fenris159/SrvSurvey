...
public sealed class CodexDiscoveryLocationClientTests
{
    ...
    public async Task ResolvesBodyRegionAndSpanshLink()
    {
        ...
        Assert.Equal("https://spansh.co.uk/body/123456789", result.Location.SpanshUri.AbsoluteUri);
    }
    ...
    public async Task FallsBackToSystemWhenBodyIsUnknown()
    {
        ...
        Assert.Equal("https://spansh.co.uk/system/42", result.Location.SpanshUri.AbsoluteUri);
    }
