...
public sealed class SpanshRouteUrlParserTests
{
    ...
    [Theory]
    [InlineData("https://spansh.co.uk/riches/results/74FA2952-2048-11F1-8302-B948FF6DF5C1", SpanshRouteKind.Riches)]
    [InlineData("https://spansh.co.uk/ammonia/results/74FA2952-2048-11F1-8302-B948FF6DF5C1", SpanshRouteKind.Riches)]
    [InlineData("https://spansh.co.uk/earth/results/74FA2952-2048-11F1-8302-B948FF6DF5C1", SpanshRouteKind.Riches)]
    [InlineData(
    ...
    public void TouristSearchUsesTheJobIdAfterResults()
    {
        ...
        Assert.True(parsed);
        Assert.Equal(new SpanshRouteReference(RouteId, SpanshRouteKind.Tourist), route);
    }
