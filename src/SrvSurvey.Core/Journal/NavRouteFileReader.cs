...
public sealed record NavRouteSnapshot(DateTimeOffset Timestamp, string EventName, IReadOnlyList<NavRouteEntry> Route);
...
public sealed record NavRouteReadResult(NavRouteSnapshot? Snapshot, string? ContentHash, string? Error, int Attempts)
{
