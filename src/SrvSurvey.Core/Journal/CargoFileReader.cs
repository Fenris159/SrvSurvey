...
public sealed record CargoItem(string Name, string? LocalizedName, int Count, int Stolen);

public sealed record CargoReadResult(CargoSnapshot? Snapshot, string? ContentHash, string? Error, int Attempts)
{
