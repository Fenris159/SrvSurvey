...
#pragma warning restore CA2213
    ...
    private async Task<bool> ExecuteGlobalInputActionAsync(GlobalInputAction action)
    {
        ...
        return action switch
        {
            ...
            GlobalInputAction.MiningRig1 => viewModel is not null && await viewModel.Mining.ToggleRigAsync(1),
            GlobalInputAction.MiningRig2 => viewModel is not null && await viewModel.Mining.ToggleRigAsync(2),
            GlobalInputAction.MiningRig3 => viewModel is not null && await viewModel.Mining.ToggleRigAsync(3),
            GlobalInputAction.MiningRig4 => viewModel is not null && await viewModel.Mining.ToggleRigAsync(4),
            GlobalInputAction.MiningRig5 => viewModel is not null && await viewModel.Mining.ToggleRigAsync(5),
            GlobalInputAction.MiningRig6 => viewModel is not null && await viewModel.Mining.ToggleRigAsync(6),
