...
{
    public static readonly StyledProperty<string?> ArtifactCodeProperty = AvaloniaProperty.Register<
    ...
    private static bool TryResolveType(string? code, out GuardianPoiType type)
    {
