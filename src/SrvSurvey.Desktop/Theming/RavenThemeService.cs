...
{
    private static readonly IReadOnlyDictionary<string, string> OverlayResourceKeys = new Dictionary<string, string>(
    ...
    )
    {
        ...
        ["RavenOverlayBioConfirmedDimPotentialBrush"] = "bio.confirmedDimPotential",
        ["RavenOverlayBioPredictionBrush"] = "bio.prediction",
        ["RavenOverlayBioPredictionPotentialBrush"] = "bio.predictionPotential",
        ...
        ["RavenOverlayBioGoldDimPotentialBrush"] = "bio.goldDarkPotential",
        ["RavenOverlayBioGalacticRegionBrush"] = "bio.galacticRegion",
        ["RavenOverlayBioGalacticRegionPotentialBrush"] = "bio.galacticRegionPotential",
    ...
    )
    {
        ...
        this.overlayTheme = overlayTheme ?? LegacyOverlayThemeStore.CreateDefault();
    ...
    public IReadOnlyList<RavenThemeDefinition> AvailableThemes { get; } = RavenThemeCatalog.All;
    ...
    private void ApplyApplicationTheme(RavenThemeDefinition theme)
    {
        ...
        SetBrush(
            ...
            theme.Key == "monochrome-dark" ? theme.AccentForegroundColor : theme.MutedTextColor
        );
    ...
    private void ApplyFluentAccent(string value)
    {
        ...
        application.Resources["SystemAccentColorLight1"] = Mix(accent, Colors.White, 0.15);
        application.Resources["SystemAccentColorLight2"] = Mix(accent, Colors.White, 0.30);
        application.Resources["SystemAccentColorLight3"] = Mix(accent, Colors.White, 0.45);
        application.Resources["SystemAccentColorDark1"] = Mix(accent, Colors.Black, 0.15);
        application.Resources["SystemAccentColorDark2"] = Mix(accent, Colors.Black, 0.30);
        application.Resources["SystemAccentColorDark3"] = Mix(accent, Colors.Black, 0.45);
    }
    ...
    private void SetInsetShadow(string key, string value)
    {
        ...
        application.Resources[key] = new BoxShadows(
            new BoxShadow
            {
                Blur = 10,
    ...
    private void ApplyDepthResources(RavenThemeDefinition theme)
    {
        ...
        {
            application.Resources["RavenWarningInsetShadow"] = new BoxShadows();
