...
{
    public static OverlayPreviewSimulationState Default { get; } =
        new(
            "CMDR Raven",
            "Synuefe NL-N C23-4",
...
internal static class OverlayPreviewSimulationProjector
{
        ...
        return definition.Name switch
        {
            ...
            "PlotBioSystem" => Content(
                ...
                BioRow(
                    ...
                    Known(1_000_000),
                    Known(2_400_000),
                    Known(7_600_000, highlighted: true),
                    Unknown()
                ),
                BioRow(
                    "A5",
                ...
                BioRow("BC3", "20.7 M", Known(4_100_000), Known(16_600_000)),
                BioRow("BC4", "1.69 M - 19.01 M", Predicted(1_690_000, 19_010_000), Known(7_600_000))
            ),
            ...
            "PlotMiningNotifications" => Content(
                "MINING",
                "Platinum 34.8%",
                "Refined Platinum ×1",
            ...
            "PlotMiningFiregroups" => Content(
                "FIREGROUPS",
                "Group A",
                "Primary: Mining laser",
                Row("Secondary", "Collector limpet")
            ),
            "PlotMiningWarning" => Content(
                "WARNING",
                "TOO FAR FROM RIGS",
                "Moving beyond 4.5Km will Destroy Rigs",
            ...
            "PlotStationInfo" => Content(
                ...
                Row(
                    "Services",
                    "Shipyard | Outfitting | Vista",
                    glyph: "✓",
                    glyphTone: OverlayPreviewGlyphTone.Success
                ),
            ...
            "PlotSysStatus" => Content(
                ...
                Row("DSS remaining", "B 1 · B 2 a · C 3", glyph: "◆", glyphTone: OverlayPreviewGlyphTone.Information),
                Row("Biological remaining", "A4 · A5 · BC3", glyph: "☀", glyphTone: OverlayPreviewGlyphTone.Gold),
            ...
            _ => throw new InvalidOperationException($"No simulated preview state is defined for {definition.Name}."),
        };
    }
    ...
    {
        return new OverlayPreviewSimulationContent(subtitle, context, footer, compactText, rows);
    }
    ...
    {
        return new OverlayPositionPreviewRowViewModel(label, value, progress, glyph, glyphTone);
    }
    ...
    private static OverlayPositionPreviewRowViewModel RouteBodyRow(FollowRouteBioTarget target)
    {
    ...
    private static BiologySignalRewardBandViewModel Known(long reward, bool highlighted = false, bool dimmed = false) =>
        BiologySignalRewardBandViewModel.Known(reward, highlighted, dimmed, BiologyRewardThresholds.Default);

    private static BiologySignalRewardBandViewModel Predicted(long minimumReward, long maximumReward) =>
    ...
    private static BiologySignalRewardBandViewModel Unknown() =>
        BiologySignalRewardBandViewModel.Unknown(BiologyRewardThresholds.Default);
}
