...
public sealed class BookmarksViewModel : WorkspaceObservable
{
    ...
    public BookmarksViewModel(string directory, Action<Guid>? openSurfaceMiningMap = null)
    {
        ...
        try
        {
            catalog = new BookmarkCatalog(directory);
        }
        catch (Exception ex) when (ex is IOException or UnauthorizedAccessException or JsonException)
        {
            status = "Bookmarks could not be loaded: " + ex.Message;
        }
        ...
        DeleteCommand = new WorkspaceCommand(() =>
            Run(() =>
            {
                if (selected is not null)
                {
                    deleted = selected;
                    catalog!.Delete(selected.Id);
                }
                Selected = null;
    ...
    public IReadOnlyList<GalacticBookmark> Items => sorter.Apply(catalog?.Filter(CategoryFilter, Query) ?? []);
    ...
    public string CategoryFilter
    {
        ...
        set
        {
            if (Set(ref categoryFilter, value))
            {
                Changed(nameof(Items));
            }
        }
    ...
    public IReadOnlyList<string> CategoryAssignments =>
    ...
    public bool CategoryMining
    {
        get => HasCategory(BookmarkCategoryCatalog.Mining);
        set => SetCategory(BookmarkCategoryCatalog.Mining, value);
    }
    public bool CategorySurfaceMining
    {
        get => HasCategory(BookmarkCategoryCatalog.SurfaceMining);
        set => SetCategory(BookmarkCategoryCatalog.SurfaceMining, value);
    }
    public bool CategoryLocation
    {
        get => HasCategory(BookmarkCategoryCatalog.Location);
        set => SetCategory(BookmarkCategoryCatalog.Location, value);
    }
    public bool CategoryPoi
    {
        get => HasCategory(BookmarkCategoryCatalog.Poi);
        set => SetCategory(BookmarkCategoryCatalog.Poi, value);
    }
    public bool CategoryOther
    {
        get => HasCategory(BookmarkCategoryCatalog.Other);
        set => SetCategory(BookmarkCategoryCatalog.Other, value);
    }
    public string Notes
    {
        get => notes;
    ...
    {
        get => minerals;
        set => Set(ref minerals, value);
    }
    public string Overlaps
    {
        get => overlaps;
        set => Set(ref overlaps, value);
    }
    public string ResourceExtractionSites
    {
        get => res;
        set => Set(ref res, value);
    }
    public int Rating
    {
        get => rating;
    ...
    {
        get => lastMined;
        set => Set(ref lastMined, value);
    }
    public string Hotspot
    {
        get => hotspot;
        set => Set(ref hotspot, value);
    }
    public string AverageYield
    {
        get => averageYield;
        set => Set(ref averageYield, value);
    }
    public int SurfaceSignal
    {
        get => surfaceSignal;
        set => Set(ref surfaceSignal, Math.Max(1, value));
    }
    public string SurfaceBodyType
    {
        get => surfaceBodyType;
        set => Set(ref surfaceBodyType, value);
    }
    public double SurfaceArrivalDistanceLs
    {
    ...
    public GalacticBookmark? Selected
    {
        ...
        set
        {
            ...
            SetCategoryAssignments(value.EffectiveCategoryAssignments);
            Notes = value.Notes;
            Minerals = value.Minerals;
            Rating = value.Rating;
            LastMined = value.LastMined;
            Hotspot = value.Hotspot;
            AverageYield = value.AverageYield;
            Overlaps = value.Overlaps;
            ResourceExtractionSites = value.ResourceExtractionSites;
    ...
    {
        return Selected is { } bookmark && OpenSurfaceMiningMap(bookmark.Id);
    }
    ...
    public void AttachScreenshots(IEnumerable<string> paths) =>
        Run(() =>
        {
            if (Selected is { } bookmark)
            {
                ...
                catalog!.Save(updated);
                Selected = updated;
                Status = $"{updated.Screenshots.Count} screenshots attached.";
            }
        });

    public void AddMiningLocation(GalacticBookmark bookmark) =>
        Run(() =>
        {
            catalog!.Save(bookmark);
    ...
    public void Import(string json) =>
        ...
        {
            catalog!.Import(json);
            Status = "Bookmarks imported; existing locations retained.";
        });
