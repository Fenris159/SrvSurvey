...
public static class GuideCatalog
{
    ...
    private static IReadOnlyList<GuideIconViewModel> CreateIconGlossary()
    {
        ...
        [
            ...
            Icon(GuideIconKind.BiologyRewardPredicted, "", "Predicted reward PIPs", "Diagonal hatching marks a predicted organism or reward. Solid prediction segments show the dependable lower band; the darker possible segment shows how high the reward range may extend. Additional PIPs beyond the reported signal count are alternative genus candidates, not additive rewards.", "Bio signals and biology predictions", "bars pips estimate range hatched potential alternative genus overflow"),
