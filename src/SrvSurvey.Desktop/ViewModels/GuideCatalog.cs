                ...
                [
                    ...
                    Section(
                        ...
                        [
                            ...
                            "Use Size−/Size+ for circle diameter, Height−/Height+ for oval proportions, and R−/R+ for outline rotation. The cyan curved guides follow the bar shape sampled by the detector. Each circle centre can be positioned independently to match the sloping cockpit HUD.",
                            "Search−/Search+ adjust the movement search allowance in pixels. The readout and optional Search bounds outline show its extent; this does not move or rotate the guides. Keep the search area inside the capture frame. Changing size, height, rotation or alignment requires learning the labels again; changing Search alone retains them.",
                            "While stationary and looking forward, select Test to hide the guides and previews, then return focus to Elite to learn the small labels next to your circles. Check the six slot readings before driving. A question mark means the view is not recognized.",
