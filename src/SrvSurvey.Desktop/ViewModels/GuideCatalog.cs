...
public static class GuideCatalog
{
    ...
    private static IReadOnlyList<GuideIconViewModel> CreateIconGlossary()
    {
        ...
        [
            ...
            Icon(GuideIconKind.GuardianRelic, "", "Guardian relic tower", "A triangle represents a relic tower. Filled versus outline state reports whether the surveyed point is present.", "Guardian site map"),
            Icon(GuideIconKind.GuardianArtifact, "", "Guardian artifact point", "A circular point represents an Orb, Casket, Tablet, Totem, or Urn. The map legend and point label distinguish the artifact type.", "Guardian site map", "orb casket tablet totem urn"),
            Icon(GuideIconKind.GuardianEmptyPuddle, "", "Empty puddle", "A circle in the configured empty-state color identifies a surveyed artifact puddle with no object present.", "Guardian site map"),
            Icon(GuideIconKind.GuardianObelisk, "", "Guardian obelisk", "A triangle with a center stroke is an obelisk. An extra ring marks active/target state and success fill marks scanned state.", "Guardian site map and Ram Tah"),
            Icon(GuideIconKind.GuardianBrokenObelisk, "", "Broken obelisk", "A crossed X identifies a broken obelisk.", "Guardian site map"),
            Icon(GuideIconKind.GuardianPylon, "", "Guardian energy pylon", "An outlined diamond identifies an energy pylon.", "Guardian site map"),
            Icon(GuideIconKind.GuardianComponent, "", "Guardian component tower", "A square identifies a component tower or destructible panel. Small lime, cyan, and orange-red dots identify Power Cell, Power Conduit, and Technology Component material states.", "Guardian site map"),
            ...
            Icon(GuideIconKind.GuardianSiteHeading, "", "Guardian site heading", "A secondary-color diagonal stroke is the site alignment heading used by the projected layout.", "Guardian site map legend"),
            Icon(GuideIconKind.GuardianTowerHeading, "", "Guardian tower heading", "A gold/empty-color diagonal stroke is the recorded relic-tower heading.", "Guardian site map legend"),
