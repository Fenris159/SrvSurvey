                ...
                [
                    ...
                    Section(
                        ...
                        [
                            ...
                            "While stationary and looking forward, select Test to hide the guides and previews, then return focus to Elite to learn the small labels next to your circles. Check the six slot readings before driving. A question mark means the label, circle or bar cannot be read confidently; the controls display the reason when learning or capture is blocked. An ellipsis means a change is awaiting confirmation. A bar already present establishes a baseline, so it can read BAR without reporting a new appearance. Later confirmed appearances and disappearances are reported after three agreeing readings.",
