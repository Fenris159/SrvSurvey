            ...
            Category(
                ...
                [
                    ...
                    Section("Announcements and firegroups", "Mining has independent ship notifications and a firegroup reference panel.",
                        ...
                        ["Mining notifications require the main ship and disappear on foot or in any SRV. Their session-only visibility and supercruise preferences are in Mining Overlay Settings. Firegroups works aboard ships, fighters and SRVs, and hides on foot; use global overlay visibility and Overlay Exceptions to control it. Existing Rhino overlays remain independent."]),
                ]),
        ];
    }
