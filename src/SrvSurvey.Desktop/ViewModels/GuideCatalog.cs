...
public static class GuideCatalog
{
                ...
                [
                    Section(
                        ...
                        [
                            ...
                            "A filled flag marks a Commander first, an outline flag marks a regional first, and a sun marks a first discovery for the Galactic region.",
                        ]),
                    Section(
    ...
    private static IReadOnlyList<GuideIconViewModel> CreateIconGlossary()
    {
        ...
        [
            ...
            Icon(GuideIconKind.Glyph, "☀", "Galactic-region first", "The organism is recorded as a first discovery for the current Galactic region, not merely a personal or Commander-regional first.", "Biology system and body predictions", "global regional first discovery biology"),
            ...
            Icon(GuideIconKind.BiologyRewardKnown, "", "Confirmed reward PIPs", "A solid PIP frame means the organism and its reward are confirmed. Each filled segment clears one reward threshold; the recessed empty slots show thresholds the reward does not reach.", "Bio signals and biology system overlays", "bars pips confirmed solid filled empty"),
            Icon(GuideIconKind.BiologyRewardPredicted, "", "Predicted reward PIPs", "Diagonal hatching marks a predicted organism or reward. Solid prediction segments show the dependable lower band; the darker possible segment shows how high the reward range may extend.", "Bio signals and biology predictions", "bars pips estimate range hatched potential"),
            Icon(GuideIconKind.BiologyRewardHighlighted, "", "Discovery-candidate PIPs", "The bright yellow or theme-highlight PIP marks a predicted global first-discovery candidate, or a regional-first candidate when regional highlighting is enabled. Hatching can still appear when its reward is predicted.", "Biology system and prediction overlays", "bars pips gold yellow highlighted first discovery regional"),
