            ...
            Category(
                ...
                [
                    ...
                    Section("Reports and backups", "Reports preserve the observations behind mining statistics.",
                        ["Select a completed session to edit notes or attach screenshots. Export HTML for graphs, material breakdowns and the prospecting timeline; open it in a browser to print or save as PDF.", "Compare all sessions, export CSV, or import EliteMining/SrvSurvey summary CSVs. Imported summaries keep their original fields without pretending that per-asteroid journal data was supplied.", "Settings → Backup exports a ZIP with commander mining data, shared bookmarks and local screenshot attachments. Restore replaces mining data and shared bookmarks with the backup contents and keeps the previous files for recovery."],
                    ...
                    Section("Announcements and firegroups", "Mining has independent ship notifications and a firegroup reference panel.",
                        ["In Mining Overlay Settings, enable Mining notifications. Firegroups has its own overlay settings window, opened beside Firegroups in the sidebar or from its workspace; placement remains in the editor’s Status & utilities category. Assign shortcuts and adjust placement in the overlay editor.", "Settings → Announcements controls collected/refined/prospecting notices, mineral thresholds, core/non-core filters and named announcement presets. Optional speech uses locally installed Windows voices.", "Firegroups, directly below Fleet Carrier in the sidebar, reads equipped modules from Loadout. Choose A–H with the arrows, add primary and secondary dropdowns with the circled plus buttons, then Add group. The tree previews all assignments. Enter a configuration name and Save; click a saved name to edit, or expand it to inspect the groups. Save and Remove sit beside the name.", "Save mining settings to persist search filters and preferences for this commander."],
