            ...
            Category(
                ...
                [
                    ...
                    Section(
                        ...
                        [
                            "Open Mining overlay settings and enable Observe rig bars while operating the Rhino. Deployment bar color defaults to the bright green game HUD; use the color picker if your HUD mod changes it. Open Edit Overlay Positions and choose Mining to show the calibration frame.",
