...
public static class GlobalInputActionCatalog
{
    ...
    [
        ...
        Define(GlobalInputAction.Track4, "track4", "Tracker/Mining Rig (4)", "Set or clear tracker 4, or mining rig 4 while operating the Rhino.", "ALT CTRL F4"),
        Define(GlobalInputAction.Track5, "track5", "Tracker/Mining Rig (5)", "Set or clear tracker 5, or mining rig 5 while operating the Rhino.", "ALT CTRL F5"),
        Define(GlobalInputAction.Track6, "track6", "Tracker/Mining Rig (6)", "Set or clear tracker 6, or mining rig 6 while operating the Rhino.", "ALT CTRL F6"),
        Define(GlobalInputAction.Track7, "track7", "Tracker/Mining Rig (7)", "Set or clear surface tracker 7. Mining uses rig slots 1-6.", "ALT CTRL F7"),
        Define(GlobalInputAction.Track8, "track8", "Tracker/Mining Rig (8)", "Set or clear surface tracker 8. Mining uses rig slots 1-6.", "ALT CTRL F8"),
