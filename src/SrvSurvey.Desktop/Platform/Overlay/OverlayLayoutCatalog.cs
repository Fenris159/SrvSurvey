...
public static class OverlayLayoutCatalog
{
    ...
    [
        ...
        Define("PlotFleetCarrierRoute", "Fleet carrier route", OverlayLayoutCategory.ExplorationAndNavigation, 460, 400, LegacyHorizontalAnchor.Right, 8, LegacyVerticalAnchor.Top, 8),
        Define("PlotRouteBio", "Route bodies", OverlayLayoutCategory.ExplorationAndNavigation, 220, 420, LegacyHorizontalAnchor.Right, 8, LegacyVerticalAnchor.Top, 8),
