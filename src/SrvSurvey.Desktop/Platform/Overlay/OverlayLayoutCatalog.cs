...
public static class OverlayLayoutCatalog
{
    ...
    [
        ...
        Define("PlotMiningNotifications", "Mining notifications", "MiningWorkspace.ShouldShowNotifications", OverlayLayoutCategory.Mining, OverlaySettingsCategory.Mining, new(360, 200), new(LegacyHorizontalAnchor.Left, 8, LegacyVerticalAnchor.Top, 100)),
        Define("PlotMiningReference", "Mining Ref", "MineMap.ShouldShowMiningReference", OverlayLayoutCategory.Mining, OverlaySettingsCategory.Mining, new(360, 160), new(LegacyHorizontalAnchor.Right, 8, LegacyVerticalAnchor.Top, 100)),
        Define("PlotMiningFiregroups", "Firegroups", "Firegroups.ShouldShow", OverlayLayoutCategory.StatusAndUtilities, OverlaySettingsCategory.Firegroups, new(220, 110), new(LegacyHorizontalAnchor.Right, 8, LegacyVerticalAnchor.Bottom, 8)),
        Define("PlotMiningWarning", "Mining rig range warning", "Mining.ShouldShowRigWarning", OverlayLayoutCategory.Mining, OverlaySettingsCategory.MineMap, new(300, 80), new(LegacyHorizontalAnchor.Center, 0, LegacyVerticalAnchor.Top, 90)),
        Define("PlotMineMap", "Mining overview map", "MineMap.ShouldShowOverlay", OverlayLayoutCategory.Mining, OverlaySettingsCategory.MineMap, new(420, 440), new(LegacyHorizontalAnchor.Left, 8, LegacyVerticalAnchor.Middle, 0, MoveVerticalAnchor: LegacyVerticalAnchor.Top)),
        Define("PlotSurfaceMining", "Surface mining", "Mining.ShouldShow", OverlayLayoutCategory.Mining, OverlaySettingsCategory.MineMap, new(320, 530), new(LegacyHorizontalAnchor.Right, 8, LegacyVerticalAnchor.Middle, 0, MoveVerticalAnchor: LegacyVerticalAnchor.Top)),
