...
public static class OverlayLayoutCatalog
{
    ...
    [
        ...
        Define("PlotMiningFiregroups", "Mining firegroups", "MiningWorkspace.ShouldShowFiregroups", OverlayLayoutCategory.Mining, OverlaySettingsCategory.Mining, new(360, 80), new(LegacyHorizontalAnchor.Left, 8, LegacyVerticalAnchor.Top, 320)),
