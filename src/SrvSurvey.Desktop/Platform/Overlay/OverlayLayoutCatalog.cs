...
public static class OverlayLayoutCatalog
{
    ...
    [
        ...
        Define("PlotMiningFiregroups", "Firegroups", "MiningWorkspace.ShouldShowFiregroups", OverlayLayoutCategory.StatusAndUtilities, OverlaySettingsCategory.Global, new(220, 110), new(LegacyHorizontalAnchor.Right, 8, LegacyVerticalAnchor.Bottom, 8)),
