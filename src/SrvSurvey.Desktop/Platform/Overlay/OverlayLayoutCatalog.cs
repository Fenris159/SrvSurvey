...
public static class OverlayLayoutCatalog
{
    ...
    [
        ...
        Define("PlotBodyInfo", "Body information", "SystemSurvey.AutoShowBodyInfo", OverlayLayoutCategory.ExplorationAndNavigation, 320, 280, LegacyHorizontalAnchor.Left, 8, LegacyVerticalAnchor.Top, 8),
        Define("PlotBuildCommodities", "Colonization commodities", "Colonization.AutoShowCommodityOverlay", OverlayLayoutCategory.CombatAndColonization, 200, 400, LegacyHorizontalAnchor.Right, 8, LegacyVerticalAnchor.Top, 8),
        ...
        Define("PlotFloatie", "Notifications", "Notifications.Enabled", OverlayLayoutCategory.StatusAndUtilities, 200, 80, LegacyHorizontalAnchor.Center, 0, LegacyVerticalAnchor.Bottom, 24),
        ...
        Define("PlotFSSInfo", "FSS information", "SystemSurvey.AutoShowFssInfo", OverlayLayoutCategory.ExplorationAndNavigation, 300, 400, LegacyHorizontalAnchor.Left, 8, LegacyVerticalAnchor.Top, 8),
        ...
        Define("PlotStationInfo", "Station information", "StationInfo.AutoShow", OverlayLayoutCategory.CombatAndColonization, 200, 300, LegacyHorizontalAnchor.Left, 8, LegacyVerticalAnchor.Middle, 0),
