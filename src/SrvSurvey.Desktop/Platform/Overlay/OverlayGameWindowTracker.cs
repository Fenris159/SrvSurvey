...
public sealed class OverlayGameWindowTracker : IGameWindowTracker
{
    ...
    public OverlayGameWindowTracker(IGameWindowTracker inner, Func<bool> keepWhenGameLosesFocus)
    {
        this.inner = inner ?? throw new ArgumentNullException(nameof(inner));
        this.keepWhenGameLosesFocus =
            keepWhenGameLosesFocus ?? throw new ArgumentNullException(nameof(keepWhenGameLosesFocus));
    }
