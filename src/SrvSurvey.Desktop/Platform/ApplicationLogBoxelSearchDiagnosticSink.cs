...
public sealed class ApplicationLogBoxelSearchDiagnosticSink(ApplicationLogService applicationLog)
    : IBoxelSearchDiagnosticSink
{
    private readonly ApplicationLogService applicationLog =
        applicationLog ?? throw new ArgumentNullException(nameof(applicationLog));
