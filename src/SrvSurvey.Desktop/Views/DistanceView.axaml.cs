...
public sealed partial class DistanceView : UserControl
{
    ...
    private async void Distance_Click(object? sender, RoutedEventArgs e)
    {
        if (Model is { } vm)
        {
    ...
    private void CurrentOrigin_Click(object? sender, RoutedEventArgs e)
    {
        if (Model is { } vm)
        {
            vm.Origin = vm.CurrentSystem;
        }
    }
    ...
    private void Home_Click(object? sender, RoutedEventArgs e)
    {
        if (Model is { } vm)
        {
            vm.Destination = vm.Settings.HomeSystem;
        }
    }
}
