...
public sealed class CombatSettingsStore
{
    ...
    public CombatPreferences Load()
    {
        ...
        CombatPreferences defaults = CombatPreferences.Default;
        return new CombatPreferences(
            GetBoolean(settings, "AutoShowFootCombat", defaults.AutoShowFootCombat),
            GetBoolean(settings, "AutoShowMassacreMissions", defaults.AutoShowMassacreMissions),
    ...
    public void Save(CombatPreferences preferences)
    {
        ...
        documentStore.Update(root =>
        {
            ...
            settings["AutoShowMassacreMissions"] = preferences.AutoShowMassacreMissions;
...
{
    public static CombatPreferences Default { get; } =
        new(AutoShowFootCombat: false, AutoShowMassacreMissions: false, SuppressForActiveBuildProjects: false);
}
