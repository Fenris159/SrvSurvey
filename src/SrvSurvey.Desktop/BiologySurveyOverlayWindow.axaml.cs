...
public sealed partial class BiologySurveyOverlayWindow : Window
{
    public BiologySurveyOverlayWindow()
        : this(CreateDesignViewModel())
    {
    }

    public BiologySurveyOverlayWindow(SystemSurveyOverlayViewModel viewModel)
    {
