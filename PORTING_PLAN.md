...
and predicted organisms. Canonn hints, live Elite attachment, and Linux remain open; the restored
...
- [ ] System/body/FSS information and route overlays.
  ...
  and exact prediction inputs plus Commander Codex first-discovery cues are
  implemented, while its auxiliary Canonn hint remains open. `FormPredictions` is implemented as a standalone system/body
...
- `dotnet test SrvSurvey.CrossPlatform.slnx --configuration Release --no-restore`
  passed all 1,013 tests: 613 Core tests and 400 Desktop tests.
