...
- Automated Guardian live coverage now includes multi-digit settlement indexes,
  ...
  `SendText` bootstrap events cannot replay mutations. The revised live
  plotter awaits final visual QA.
